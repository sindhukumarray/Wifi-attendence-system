    ...
    <aside className="w-72 bg-[#020617] text-white min-h-screen hidden md:flex flex-col flex-shrink-0 relative z-20 border-r border-slate-800/50">
      <div className="p-8 mb-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-black tracking-tight text-white">SmartFlow</h2>
        </div>
      </div>

      <nav className="flex-1 px-4 space-y-2 overflow-y-auto custom-scrollbar">
        <div className="px-4 mb-4 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Main Menu</div>
        ...
        {user?.role === 'admin' && (
          <>
            ...
            <NavLink to="/admin/faculty" className={navClass}>
        ...
        {user?.role === 'faculty' && (
          <>
            ...
            <NavLink to="/faculty/session" className={navClass}>
            ...
            <NavLink to="/faculty/reports" className={navClass}>
        ...
        {user?.role === 'student' && (
          <>
            ...
            <NavLink to="/student/analytics" className={navClass}>
            ...
            <NavLink to="/student/devices" className={navClass}>
      ...
      <div className="p-6">
        <div className="bg-slate-800/40 rounded-[2rem] p-6 border border-slate-700/50">
          ...
          <button 
            onClick={logout}
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-red-500/10 text-red-500 font-bold hover:bg-red-500 text-sm transition-all duration-300 group hover:text-white"
          >
